<template>
  <div class="aboutDiv">
    <img class="titleImg" src="../assets/Titolo-2dpi.png" alt="header" />
    <div class="divText">
    ...
    <div class="divText">
      <img class="div-img" src="../assets/media-dpi.png" alt="header" />
    ...
    <div class="divText">
      ...
      <img class="div-img" src="../assets/updpi.png" alt="header" />
    </div>
    <div class="divText">
      <img class="div-img" src="../assets/indexdpi.png" alt="header" />
    ...
    <div class="divText">
      <p>Empower sustainability: One-stop online shop for sustainable products. The Eco marketplace for sustainable products
         was an idea born back in 2015 during the conception of IMPAKTER INDEX. ECO : Online marketplace for sustainable 
         products verified by the IMPAKTER INDEX (only products rated A and B are sold in the market).
      </p>
      <img class="div-img" src="../assets/ecodpi.png" alt="header" />
    </div>
  </div>
</template>
